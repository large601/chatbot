public class Magpie4
{
	...
	public boolean aboutsports = false;
	...
	public String getResponse(String statement)
	{
		...
		else if (findKeyword(statement, "sport") >= 0 || findKeyword(statement, "species") >= 0){
		...
		// Code that demonstrates interaction across the specific topic
		else if (aboutsports == true){
			if (findKeyword(statement, "yes") >= 0){
				response = "Do you find sports interesting? ";
				return response;
			}
			else if (findKeyword(statement, "no") >= 0){
				response = "If you were an sport player, would you be a soccer player or basketball player? ";
				aboutsports = false;
				return response;
			}
			else if (findKeyword(statement, "soccer") >= 0){
				response = "Who's your favorite soccer player? ";
				return response;
			}
			...
			else if (findKeyword(statement, "neither") >= 0 || findKeyword(statement, "league player") >= 0){
				response = "You should play some sports";
				return response;
			}
			else {
